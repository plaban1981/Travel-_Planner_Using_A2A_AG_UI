#!/usr/bin/env python3
"""
Script to help create .env files for the hotel booking agent.
"""
...
def create_env_file():
    ...
    env_content = """# Hotel Booking Agent Environment Variables
...
"""
    ...
    try:
        ...
        print("2. Replace 'your_serper_api_key_here' with your actual SerperAPI key")
        print("3. Save the file")
        print("4. Run: python simple_executor.py")
...
if __name__ == "__main__":
    print("🔧 Hotel Booking Agent Environment Setup Helper")
    print("=" * 50)
